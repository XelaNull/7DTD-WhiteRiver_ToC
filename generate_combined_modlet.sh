...
while read moddir; do
  ...
  echo "  - Description: $DESCRIPTION" >> CombinedModlet/MODLIST.md
	...
	# echo "Outside of Localization code";
  ...
  if [[ -f $moddir/Config/Localization.txt ]]; then
			...
			# echo "Writing Localization Header";
    ...
    # echo "" >> CombinedModlet/Config/Localization.txt
		# echo "Calling ../parse-localization.php $moddir/Config/Localization.txt";
		# echo `pwd;ls -l ../parse-localization.php`;
    #../parse-localization.php "$moddir/Config/Localization.txt" >> CombinedModlet/Config/Localization.txt
		#../parse-localization.php "$moddir/Config/Localization.txt" >> "$moddir/Config/Localization.txt"
		echo "Key,File,Type,UsedInMainMenu,NoTranslate,english,Context / Alternate Text,german,latam,french,italian,japanese,koreana,polish,brazilian,russian,turkish,schinese,tchinese,spanish" > TEMP-Localization.txt
		../parse-localization.php "$moddir/Config/Localization.txt" >> TEMP-Localization.txt
		cp TEMP-Localization.txt CombinedModlet/Config/Localization.txt;
		cp TEMP-Localization.txt "$moddir/Config/Localization.txt"
		rm -rf TEMP-Localization.txt
  fi
  # Handle Files named "localization.txt"
  #if [[ -f $moddir/Config/localization.txt ]]; then
  #  if [[ ! -f CombinedModlet/Config/localization.txt ]]; then
...
echo `pwd`
echo "#### Publishing Combined Modlet to ../7DTD-WhiteRiver_ToC-combined/WhiteRiverToC-combined/"
...
mv ../../7DTD-WhiteRiver_ToC-combined/WhiteRiverToC-combined/MODLIST.md ../../7DTD-WhiteRiver_ToC-combined/README.md
